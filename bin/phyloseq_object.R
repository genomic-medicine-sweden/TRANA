...
# # # # # # # # # # # # # # # # #
gms16s_to_phyloseq <- function(counts_file,
                               taxonomy_file,
                               sep_file_sample = "_",
                               n_parts_filename_to_sample = 1) {
  # print(counts_file)
  # print(taxonomy_file)
  ...
  otu_tab_df <- tidyr::pivot_wider(otu_df,
                                   id_cols = tax_id,
                                   names_from = Sample,
...
remove_genus_prefix_from_species <- function(tax_tab, i_genus, i_species) {
  ...
  new_tax_table_t <- sapply(rownames(tax_tab), function(rn,
                                                        tax_tab,
                                                        i_genus,
                                                        i_species) {
...
tax_table(phyloseq_object) <- remove_genus_prefix_from_species(tax_table(phyloseq_object),
                                                       i_genus = 7,
                                                       i_species = 8)
